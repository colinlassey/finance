  ...
  const monthlyTopCategories = useMemo(
    () =>
      Object.entries(monthly.categories)
        ...
        .slice(0, 5),
    [monthly.categories, store.categories],
  );
    ...
    <div className="min-h-screen bg-zinc-950 p-6 text-zinc-100">
      ...
      <div className="grid gap-4 lg:grid-cols-12">
        <AccountsPanel
          ...
          onCreate={(name) =>
            name.trim() &&
            setStore((prev) => ({ ...prev, accounts: [...prev.accounts, { id: uid(), name: name.trim() }] }))
          }
          onRename={(id, name) =>
            name.trim() &&
            setStore((prev) => ({
        ...
        <BudgetsPanel
          ...
          onCreate={(categoryId, limit) =>
            setStore((prev) => ({ ...prev, budgets: [...prev.budgets, { id: uid(), categoryId, limit }] }))
          }
        />
        ...
        <LedgerPanel
          ...
          onDelete={(id) =>
            setStore((prev) => ({ ...prev, transactions: prev.transactions.filter((t) => t.id !== id) }))
          }
        />
          ...
          onImport={(file) => {
            ...
            reader.onload = () => {
              try {
                ...
                setStore(migrateStore(incoming));
              } catch {
